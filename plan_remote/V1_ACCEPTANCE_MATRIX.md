...
| §8.12 | Tor transport reaches onion `takd` through embedded Arti with direct-transport protocol parity | Covered | `run_remote_only_tor_onion_reaches_takd_with_embedded_arti_transport_parity`, `direct_and_tor_transports_share_remote_protocol_contract` | `crates/tak`, `crates/tak-exec`, `crates/takd` |
