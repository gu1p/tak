# taskcraft-exec Architecture

## Purpose

`taskcraft-exec` is the runtime engine. It executes selected targets plus transitive dependencies in valid order, applying retries, step timeouts, and optional daemon lease coordination.
