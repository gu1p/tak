//! Embedded web graph visualization runtime for Taskcraft.
//!
...
/// # async fn demo(spec: &taskcraft_core::model::WorkspaceSpec) -> anyhow::Result<()> {
/// use taskcraft::web::serve_graph_ui;
///
...
fn should_auto_open_browser() -> bool {
    should_auto_open_browser_for(
        ...
        env_flag_set("TASKCRAFT_NO_BROWSER_OPEN"),
    )
}
...
mod tests {
    ...
    use taskcraft_core::model::{ResolvedTask, RetryDef, TaskLabel};
