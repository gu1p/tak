...
use crate::runtime_metadata::resolve_runtime_execution_metadata_for_node_runtime_with_workspace;
use crate::step_execution::run_task_steps_with_runtime;
...
fn image_cache_plan(
    ...
    container_plan: &crate::ContainerExecutionPlan,
) -> ImageCachePlan {
