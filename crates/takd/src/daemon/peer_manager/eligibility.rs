...
// A peer is placeable while Connected OR still Connecting. A Connecting peer
// remains a valid cold-dial candidate so initial inventory warm-up does not
// remove it from daemon-authored placement diagnostics.
