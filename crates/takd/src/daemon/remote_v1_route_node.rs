fn handle_node_metadata_route(method: &str, path_only: &str) -> Option<RemoteV1Response> {
...
fn handle_remote_cancel_route(method: &str, path_only: &str) -> Option<RemoteV1Response> {
